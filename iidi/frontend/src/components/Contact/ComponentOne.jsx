            ...
            <main className="max-w-6xl w-full mx-auto relative z-10">
                <header className="flex justify-between items-start mb-8">
                    ...
                    <div className="flex flex-col space-y-4">
                        <SocialIcon href="https://www.facebook.com/share/175nHergUy/?mibextid=wwXIfr">
                        ...
                        <SocialIcon href="https://www.instagram.com/iidi_official?igsh=eDZrOXV0b3czZW11&utm_source=qr">
